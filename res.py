...
def stat(args):
    with open('result/result.txt', 'r', encoding='utf-8') as f:
        for line in f:
            ...
            for score_text, score_graph in zip(obj['score_texts'], obj['score_graphs']):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-dataset', type=str, default='', choices=['', 'moocen', 'mooczh', 'cs', 'math', 'psy', 'phy', 'chem'])
